import{a as P}from"./chunk-TV3AL2YO.js";import{Ha as A,Ia as g,j as Q,l as E,p as N,s as O,ya as q}from"./chunk-2EMEEHE6.js";import{$a as b,Ab as w,Hb as l,Ib as D,Jb as F,Mb as f,Oa as o,Ob as m,P as v,Pb as y,Q as h,Tb as j,Ub as S,V as T,_b as z,ab as C,da as p,db as $,fb as r,mb as i,pb as k,qb as I,wb as u,wc as B,xb as d,yb as x,zb as M}from"./chunk-QN2SJYEL.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
